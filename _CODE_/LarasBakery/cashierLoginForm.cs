...
namespace AlphaSoft
{
    public partial class cashierLoginForm : Form
    {
        ...
        private loginForm originForm;

        public cashierLoginForm(int status, loginForm parentForm)
        {
            InitializeComponent();
            loginState = status;
        ...
        private void continueButton_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                {
                    adminForm displayAdminForm = new adminForm(gUtil.getUserID(), gUtil.getUserGroupID(), originForm);
