...
namespace AlphaSoft
{
    public partial class salesQuotationPrintOutForm : Form
    {
        private globalUtilities gUtil = new globalUtilities();

        public salesQuotationPrintOutForm()
        {
            InitializeComponent();
        }

        private void salesQuotationPrintOutForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SalesQuotation rptXMLReport = new SalesQuotation();
